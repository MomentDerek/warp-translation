#!/usr/bin/env python3
"""Apply batch-17 merged translations to translations/strings.json.

Batch-17 is a 6-way parallel merge spanning 383 entries (file-pinned).
Sub-batches:

  A: app/src/code_review/{telemetry_event, git_dialog/mod, code_review_view, comment_list_view}.rs  (66)
  B: ai/blocklist/.../diff_application.rs + ai/mcp/templatable_manager/native.rs + ai/aws_credentials.rs  (67)
  C: terminal/view/block_onboarding/onboarding_agentic_suggestions_block.rs + ai/{usage,orchestration,execution_profiles}  (63)
  D: workspace/tab_settings.rs + settings_view/{update_environment_form, mod}.rs  (57)
  E: remote_server/server_model.rs + crates/remote_server/src/client/mod.rs + terminal/{ssh/error, share_block_modal}.rs  (65)
  F: workspace/view/{build_plan_migration_modal, launch_modal/oz_launch}.rs + cloud_object/toast_message.rs + context_chips/mod.rs  (65)
...
BATCH_FLAG = "pr-by-file-parallel-batch-18"
