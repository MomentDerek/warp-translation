#!/usr/bin/env python3
"""Apply batch-16 merged translations to translations/strings.json.

Batch-16 is a 6-way parallel merge spanning 371 entries (file-pinned).
Sub-batches:

  A: app/src/ai/blocklist/passive_suggestions/static_prompt_suggestions.rs   (46)
  B: app/src/ai/blocklist/block/view_impl/common.rs + settings/ai.rs         (64)
  C: app/src/ai/agent_tips.rs + terminal/view/ambient_agent/tips.rs          (80)
  D: app/src/editor/view/mod.rs + settings_view/appearance_page.rs           (64)
  E: app/src/settings/import/iterm_parser.rs + terminal/view/init_project/mod.rs (65)
  F: app/src/drive/index.rs + app/src/search/data_source.rs                  (52)
...
BATCH_FLAG = "pr-by-file-parallel-batch-16"
