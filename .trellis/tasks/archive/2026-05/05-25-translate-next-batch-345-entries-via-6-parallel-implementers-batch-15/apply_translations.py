#!/usr/bin/env python3
"""Apply batch-15 merged translations to translations/strings.json.

Batch-15 is a 6-way parallel merge spanning 331 entries (file-pinned).
Sub-batches:

  A: app/src/terminal/view.rs                                          (59)
  B: crates/ai/src/agent/action_result/mod.rs                          (56)
  C: crates/ai/src/agent/action/mod.rs                                 (54)
  D: app/src/ai/blocklist/block/view_impl/output.rs                    (53)
  E: app/src/workspace/view.rs + workspace/view/vertical_tabs.rs       (65)
  F: app/src/ai/agent/mod.rs                                           (44)
...
BATCH_FLAG = "pr-by-file-parallel-batch-15"
