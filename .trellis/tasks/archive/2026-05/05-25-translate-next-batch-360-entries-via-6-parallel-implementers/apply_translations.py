#!/usr/bin/env python3
"""Apply batch-14 merged translations to translations/strings.json.

Batch-14 is a 6-way parallel merge spanning 360 entries (60 per sub-batch,
each pinned to a single source file). Sub-batches:

  A: crates/ai/src/agent/action_result/mod.rs
  B: app/src/terminal/view.rs
  C: app/src/workspace/view.rs
  D: app/src/settings/ai.rs
  E: crates/warpui/examples/table-sample/root_view.rs
  F: app/src/terminal/input.rs
...
BATCH_FLAG = "pr-by-file-parallel-batch-14"
